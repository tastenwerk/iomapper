...
var UserSchema = mongoose.Schema({
      ...
      preferences: {type: mongoose.Schema.Types.Mixed, default: { common: { locale: 'en', hosts: [] }, docklets: [ 'notification_service/docklets/summary', 'notification_service/docklets/clock' ] } },
...
UserSchema.method('badGuys',
 'loginLog hashedPassword salt password lastRequest confirmation'
);
...
UserSchema.method('toJSON', function() {
  obj = this.toObject();
  obj.confirmed = (typeof(this.confirmation.key) === 'undefined') || (this.confirmation.key && this.confirmation.key.length > 0);
  obj.lastLoginAt = (this.loginLog && this.loginLog.length > 0 ? this.loginLog[this.loginLog.length-1].createdAt : null);
  obj.name.full = getUserFullName.call(obj);
